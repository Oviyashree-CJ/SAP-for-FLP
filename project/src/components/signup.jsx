...
const Signup = () => {
  ...
  const regex = {
    ...
    phone_no: /^[6-9]\d{9}$/, // Indian phone number (10 digits starting with 6-9)
  ...
  const validateForm = () => {
    ...
    if (!regex.phone_no.test(formData.phone_no)) {
      newErrors.phone_no = "Phone number must be a valid 10-digit number (starting 6-9).";
    }
